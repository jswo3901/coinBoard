...
class RichEditor extends Component {
    ...
    onEditorStateChange(editorState) {
        ...
        //여기서 onChange걸리면 updateDiscussionContent(액션)호출됨 
        this.setState({ editorState })
    ...
    render() {
        ...
        let saveButtonLabel = ''
        if (type === 'newOpinion') saveButtonLabel = '리플달기'
        if (type === 'newDiscussion') saveButtonLabel = '글 전송'

        let placeholder = ''
        if (type === 'newOpinion') placeholder = '댓글을 입력하세요'
        if (type === 'newDiscussion') placeholder = '내용을 입력하세요'
